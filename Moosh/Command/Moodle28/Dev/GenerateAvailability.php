...
class GenerateAvailability extends MooshCommand
{
    ...
    public function execute()
    {
        ...
        run_external_command("cp -r '{$this->synmooshDir}/vendor/danielneis/moodle-availability_newavailability' '$modPath'", "Copying from availability condition template failed");
